...
export default function RequestVerificationPage() {
  ...
  const canUpload = caseData?.allowUpload === "allow";
...
9. मैं अपनी सहमति से यह घोषणा कर रहा/रही हूँ।`;
  ...
  const startCamera = async () => {
    ...
    if (!canUpload) {
      setError("Upload access is disabled. Please contact Claimant Mitra.");
      return;
    }
    ...
    <div className="max-w-2xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
      ...
      {!canUpload ? (
        <div className="mb-4 rounded border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800">
          Upload access is disabled for this link. Please contact Claimant Mitra.
        </div>
      ) : null}
      ...
      <div className="mb-4 space-y-2">
        ...
        <div
          ...
          onTouchStart={(e) =>
            handleMarqueePointerDown(e.touches[0]?.clientX || 0)
          }
        ...
        >
          <div style={{ transform: `translateX(${marqueeManualOffsetPx}px)` }}>
            <div
              ...
              style={{
                animationPlayState: isMarqueeRunning ? "running" : "paused",
              }}
            >
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                type="button"
                onClick={startCamera}
                disabled={cameraReady || !canUpload}
              ...
              <button
                ...
                disabled={!cameraReady || isRecording || !canUpload}
                className={`px-3 py-2 rounded text-white ${
