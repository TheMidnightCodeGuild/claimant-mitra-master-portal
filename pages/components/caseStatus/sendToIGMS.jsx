...
export default function SendToIGMS({ docId, onComplete }) {
    ...
    const handleRejectCase = async () => {
        await confirmAction('You are about to reject this case.', async () => {
            try {
                if (!docId) return;
    ...
    const handleMarkAsPending = async () => {
        await confirmAction('You are about to mark this case as pending.', async () => {
            try {
                if (!docId) return;
    ...
    const handleSendConsent = async () => {
        await confirmAction('You are about to send the consent document.', async () => {
            try {
            ...
            <div className="ui-card-padded">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="mt-1 text-gray-900">{resolvePartnerDisplayName(caseData?.partnerRef, partnerMap)}</p>
                    </div>
