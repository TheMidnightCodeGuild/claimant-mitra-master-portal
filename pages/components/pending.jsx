    ...
    useEffect(() => {
        async function fetchCases() {
            try {
                ...
                const casesData = filterCasesByKey(allCases, 'pending');
                setCases(casesData);
    ...
    return (
        <div className="ui-content-max">
            <div className="ui-page-intro mb-6">
                <p className="ui-section-eyebrow">Queue</p>
                <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Pending Cases</h2>
            </div>
