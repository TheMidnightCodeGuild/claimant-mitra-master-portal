    ...
    return (
        <div className="ui-content-max">
            <div className="ui-page-intro mb-6">
                <p className="ui-section-eyebrow">Escalation</p>
                <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Ombudsman Cases</h2>
            </div>
                ...
                {filteredCases.map((case_) => (
                    ...
                    >
                        <div className="space-y-3">
                            ...
                            {case_.ombudsmanDate && (
                                <div className="mt-2 bg-blue-50 p-2 rounded-md text-sm text-indigo-700">
